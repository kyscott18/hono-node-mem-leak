...
export type RootResolver<E extends Env = any, P extends string = any, I extends Input = {}> = (ctx?: Context<E, P, I>) => Promise<unknown> | unknown;
...
export declare const graphqlServer: <E extends Env = any, P extends string = any, I extends Input = {}>(options: Options<E, P, I>) => (c: Context<E, P, I>) => Promise<Response>;
